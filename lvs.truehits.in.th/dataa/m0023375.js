var hash="0MN5IJRg4cSt29xCODW72w==";var turlnameindex='komchadluek.net';
var _hsv='lvs.truehits.in.th';
var _ht='goggen.html';
var _ctg='state1e6.html?login=kom';
var _hc='m0023375';
...
return(h%65536);}
function _ref(){var h,q,i,j,_rf=top.document.referrer;if(!_rf)return"d";if(((i=_rf.indexOf(document.domain))>0)&&(i<=8))return"d";var _sre=new Array("search","yahoo","altavista","google","lycos","hotbot","msn","netscape","netster","mamma","alltheweb","aol","ask","looksmart","cnn","gigablast","siamguru","sansarn","truehits");var _skw=new Array("q","p","q","q","query","query","q","query","Keyword","query","q","query","q","qt","query","q","q","q","keyword");if((i=_rf.indexOf("://"))<0)return"d";i+=3;if((j=_rf.indexOf("https://www.komchadluek.net/",i))<0)j=_rf.length;h=_rf.substring(i,j);q=_rf.substring(j,_rf.length);if(h.indexOf("www.")==0)h=h.substring(4,h.length);if(h.length==0)return"d";if(q.length>0){for(i=0;i<_sre.length;i++){if(h.indexOf(_sre[i])>-1){if((j=q.indexOf("?"+_skw[i]+"="))>-1||(j=q.indexOf("&"+_skw[i]+"="))>-1){return"s";}}}}
return"r";}
